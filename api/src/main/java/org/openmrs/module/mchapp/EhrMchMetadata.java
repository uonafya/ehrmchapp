...
//        public static final Integer INITIAL_MCH_CLINIC_VISIT = 2;
    ...
    public void install() throws Exception {
        ...
        install(encounterType("FACILITYVISIT", "Patient visits the clinic/hospital (as opposed to a home visit, or telephone contact)", _VistTypes.FACILITY_VISIT));
        install(encounterType("INITIALMCHCLINICVISIT", "Initial Visit to the MCH Clinic", _VistTypes.INITIAL_MCH_CLINIC_VISIT));
